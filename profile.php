            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" id="form_advanced_validation" method="post" action="profile.php?id=<?php echo $idd ?>" enctype="multipart/form-data" >
							...
							<div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input id="skills" name="login"  class="form-control" placeholder="" value="<?php echo $login; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input id="skills" type="password" name="password"  class="form-control" placeholder="" value="<?php echo $password; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input id="skills" name="nomclient"  class="form-control" placeholder="" value="<?php echo $nomclient; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
								   ...
								   <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input id="skills" name="prenom"  class="form-control" placeholder="" value="<?php echo $prenom; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input id="skills" name="societe"  class="form-control" placeholder="" value="<?php echo $societe; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input id="skills" name="email"  class="form-control" placeholder="" value="<?php echo $email; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input id="skills" name="tel"  class="form-control" placeholder="" value="<?php echo $tel; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input id="skills" name="mobile"  class="form-control" placeholder="" value="<?php echo $mobile; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input id="skills" name="adr"  class="form-control" placeholder="" value="<?php echo $adr; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                             ...
                             <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
							<div class="fallback">
                                    <input name="fileToUpload" type="file" value="<?php echo $photo; ?>" />
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="submit" >Valider</button>
                                    </div>
                                </div>
